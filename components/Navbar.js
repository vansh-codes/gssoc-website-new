...
export const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex items-center transition-colors flex-wrap bg-white drop-shadow-xl p-1 justify-center mb-24 dark:bg-slate-800 dark:text-primary_orange-0 dark:transition-colors sticky top-0 z-10">
        <Link href="/">
