            ...
            <div className="md:flex md:flex-wrap justify-center md:-mx-4 py-6 md:pb-8">
              ...
              <div className="md:w-1/3 max-w-[480px] md:px-4 md:text-left mt-12 lg:mt-0">
                <h5 className="text-base text-white font-normal mb-4">
                  GirlScript is the fastest growing tech-community in India. It
                  is a non-profit project brought to you by GirlScript
                  Foundation to help beginners in technology. Be a part, spread
                  knowledge & happiness.
                </h5>
