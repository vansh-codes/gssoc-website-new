export const accordionData = [
  ...
  {
    id: 6,
    question: "What benefits do participants get from joining GSSoC?",
    answer: "Participants in GSSoC gain valuable experience in open source development, mentorship from experienced developers, opportunities to collaborate on real-world projects, and the chance to improve their coding skills. Additionally, participants receive digital certificates and may be eligible for prizes.",
  },
  {
    id: 7,
    question: "Can international students participate in GSSoC?",
    answer: "Yes, GSSoC is open to participants from around the world. There are no geographical restrictions for joining the program.",
  },
  {
    id: 8,
    question: "What is the duration of the GSSoC program?",
    answer: "GSSoC typically runs for a duration of three months, providing ample time for participants to contribute to projects, learn new skills, and engage with mentors and peers.",
  },
  {
    id: 9,
    question: "How can organizations or projects get involved with GSSoC?",
    answer: "Organizations or project maintainers interested in participating in GSSoC can apply to have their projects included in the program. There are no such conditions that the projects need to satisfy for open source contributions.",
  },
  {
    id: 10,
    question: "What support is available for beginners in GSSoC?",
    answer: "Beginners in GSSoC receive extensive support, including access to learning resources, tutorials, and guidance from mentors. The program is designed to be beginner-friendly, ensuring that participants with no prior experience in open source can still make meaningful contributions.",
  },
  {
    id: 11,
  ...
  {
    id: 13,
    question: "What kind of projects are included in GSSoC?",
    answer: "GSSoC includes a wide variety of projects across different domains such as web development, mobile app development, machine learning, data science, and more. Projects are selected to cater to different skill levels, from beginners to advanced contributors.",
  },
  {
    id: 14,
    question:
      "Where do we start as a beginner to contribute properly in the projects?",
    answer:
  ...
  },
  {
    ...
    answer:
      "All communication will happen on the corresponding channel for the particular project in the official GSSoC '24 Discord server. ",
  },
  {
    id: 16,
    question: "How will I know that I am selected?",
    answer:
      "The participants will be notified through email and the invite to the Discord server will be sent to them. ",
  },
  {
    id: 17,
  ...
  {
    id: 19,
    question: "What are the other programs provided by GirlScript besides GSSoC (GirlScript Summer of Code)?",
    answer: "GirlScript organizes several other programs including the GirlScript Winter of Contributing (GWOC), GirlScript Winter of Blockchain (WoB), and various other initiatives aimed at promoting tech education and open source contributions.",
  },
  {
    id: 20,
    question: "How can I become a mentor for GSSoC or other GirlScript programs?",
    answer: "To become a mentor for GSSoC or other GirlScript programs, you can apply through the official GirlScript website during the mentor application period. You'll need to provide details about your expertise and experience in the field you wish to mentor.",
  },
  {
    id: 21,
  ...
  {
    id: 24,
    question: `Where can I find projects eligible for GSSoC'24?`,
    answer: `You can find the list of projects eligible for GSSoC'24 here - https://gssoc.girlscript.tech/project.`,
  },
  {
    id: 25,
  ...
  {
    id: 27,
    question: `Can I be a contributor to projects too if I am a core team member?`,
    answer: `Yes, you can be a contributor as well.`,
  },
  {
    id: 28,
    question: `Can we switch our roles after getting onboarded?`,
    answer: `Sadly, No. You can't switch. If there is a requirement and your skillset matches, we may ask you to contribute to different teams.`,
  },
  {
    id: 29,
    question: `How can the core members contribute to GSSoC's program?`,
    answer: `The roadmap has been shared above, can look into it. PMs will be in touch with you regarding the tasks.`,
  },
  {
    id: 30,
    question: `If we want to add something in GitHub org as our suggestion, do we need to raise a PR?`,
    answer: `Yes, ideally that's the right way if you want to learn how things work refer https://recodehive.com/github-tutorials/`,
  },
  {
    id: 31,
    question:
      "Registration form asks for a referral code. What should I fill in if I don't have one?",
    answer:
      "Referral codes are optional, it's the campus ambassador who passes on the referral codes. You can go ahead; this doesn't affect your application.",
  },
  {
    id: 32,
